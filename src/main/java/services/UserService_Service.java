 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://services/", wsdlLocation = "http://192.168.1.8:9763/rubricaWS_1.0.0/services/user_service?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://services/", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.1.8:9763/rubricaWS_1.0.0/services/user_service?wsdl");
